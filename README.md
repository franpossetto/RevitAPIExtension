...
###### 3. Revit DB Application
This template create an DB Application Addin. You can start writting your code opening DB Application File. This template add RevitAPI.dll and RevitAPIUI dll on your Reference and Post-Build commands to handle Revit Versions and Deploy process. 
...
###### 4. Revit Stack Buttons
This template create 3 Stack Buttons in the Ribbon Bar. You can start writting your code opening ExternalCommands File. This template add RevitAPI.dll and RevitAPIUI dll on your Reference and Post-Build commands to handle Revit Versions and Deploy process. 
