...
Create a new External Command. `RevitAddin` is the Namespace and is taken from tyour project. `NewExternalCommand` is the the Class that implements IExternalCommand interface.
```csharp
