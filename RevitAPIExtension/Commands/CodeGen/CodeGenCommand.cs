...
using RevitAPIExtension.Interfaces;
using RevitAPIExtension.QuickActions.Ribbon;
...
namespace RevitAPIExtension.Commands
{
    ...
    internal sealed class CodeGenCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("6f929c1e-9ddd-444e-b4b9-fdbf5a2c2253");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CodeGenCommand"/> class.
